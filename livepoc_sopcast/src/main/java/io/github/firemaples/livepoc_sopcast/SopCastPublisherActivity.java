...
import io.github.firemaples.livepoc_sopcast.ui.MultiToggleImageButton;
import io.github.firemaples.livestreamingpoc.recorder.RTMPPublisherActivity;

public class SopCastPublisherActivity extends RTMPPublisherActivity {

    private static final String TAG = SopCastPublisherActivity.class.getSimpleName();
    ...
    @Override
    protected void prepareRecorder(String rtmpUrl) {
        ...
        mRecordBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isRecording) {
                    ...
                    Toast.makeText(SopCastPublisherActivity.this, "stop living", Toast.LENGTH_SHORT).show();
    ...
    private void initLiveView() {
        ...
        Watermark watermark = new Watermark(watermarkImg, 50, 50, WatermarkPosition.WATERMARK_ORIENTATION_BOTTOM_RIGHT, 8, 8);
        ...
        mLFLiveView.setCameraOpenListener(new CameraListener() {
            ...
            public void onOpenSuccess() {
                Toast.makeText(SopCastPublisherActivity.this, "camera open success", Toast.LENGTH_LONG).show();
            }

            @Override
            public void onOpenFail(int error) {
                Toast.makeText(SopCastPublisherActivity.this, "camera open fail", Toast.LENGTH_LONG).show();
            }

            @Override
            public void onCameraChange() {
                Toast.makeText(SopCastPublisherActivity.this, "camera switch", Toast.LENGTH_LONG).show();
            }
        });
        ...
        mLFLiveView.setLivingStartListener(new CameraLivingView.LivingStartListener() {
            ...
            public void startError(int error) {
                //直播失败
                Toast.makeText(SopCastPublisherActivity.this, "start living fail", Toast.LENGTH_SHORT).show();
                mLFLiveView.stop();
            }
            ...
            public void startSuccess() {
                //直播成功
                Toast.makeText(SopCastPublisherActivity.this, "start living", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void startPublish() {
        if (TextUtils.isEmpty(rtmpUrl)) {
            Toast.makeText(SopCastPublisherActivity.this, "Upload address is empty!", Toast.LENGTH_SHORT).show();
        } else {
            mRtmpSender.setAddress(rtmpUrl);
            mProgressConnecting.setVisibility(View.VISIBLE);
            Toast.makeText(SopCastPublisherActivity.this, "start connecting", Toast.LENGTH_SHORT).show();
    ...
    private RtmpSender.OnSenderListener mSenderListener = new RtmpSender.OnSenderListener() {
        ...
        public void onDisConnected() {
            mProgressConnecting.setVisibility(View.GONE);
            Toast.makeText(SopCastPublisherActivity.this, "fail to live", Toast.LENGTH_SHORT).show();
            mRecordBtn.setBackgroundResource(R.mipmap.ic_record_start);
            mLFLiveView.stop();
            isRecording = false;
        }
        ...
        public void onPublishFail() {
            mProgressConnecting.setVisibility(View.GONE);
            Toast.makeText(SopCastPublisherActivity.this, "fail to publish stream", Toast.LENGTH_SHORT).show();
            mRecordBtn.setBackgroundResource(R.mipmap.ic_record_start);
            isRecording = false;
        }
    ...
    public class GestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            if (e1.getX() - e2.getX() > 100
                ...
                // Fling left
                Toast.makeText(SopCastPublisherActivity.this, "Fling Left", Toast.LENGTH_SHORT).show();
            } else if (e2.getX() - e1.getX() > 100
                    && Math.abs(velocityX) > 200) {
                // Fling right
                Toast.makeText(SopCastPublisherActivity.this, "Fling Right", Toast.LENGTH_SHORT).show();
            }
