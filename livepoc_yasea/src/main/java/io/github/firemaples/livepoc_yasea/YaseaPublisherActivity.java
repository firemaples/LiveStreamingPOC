...
public class YaseaPublisherActivity extends RTMPPublisherActivity {
    ...
    protected void prepareRecorder(String rtmpUrl) {
        ...
        setTitle(getTitle().toString() + ": " + getRoomName());
    ...
    private void initViews() {
        ...
        btnSwitchCamera.setOnClickListener(onClickListener);
        btnRecord.setOnClickListener(onClickListener);
        btnSwitchEncoder.setOnClickListener(onClickListener);
    }
    ...
    private void onSwitchEncoderClick() {
        if (btnSwitchEncoder.getText().toString().contentEquals("soft encoder")) {
